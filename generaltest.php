...
if (isset($_POST["update"])) {
    ...
    $cid=$_POST['cid'];
    $pid=$_POST['pid'];
    $update="INSERT INTO `testing`(`status`, `remarks`, `pid`, `cid`) VALUES ('$status','$remarks',$pid,$cid)";
    $result=mysqli_query($conn, $update);
 
    if ($result) {
        echo "<script>alert('Product testing updated successfully');
           ...
           <div class="col-12">
               <div class="bg-secondary rounded p-4 p-sm-5 my-4 mx-3">
                ...
                <div class="form-floating mb-3">
                   ...
                   <div class="form-floating mb-3">
                    <textarea name="remarks" class="form-control" id="floatingText" rows="5" col="6"></textarea>
